...
//+kubebuilder:rbac:groups=routeros.mikrotik.com,resources=dhcpservers,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=routeros.mikrotik.com,resources=dhcpservers/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=routeros.mikrotik.com,resources=dhcpservers/finalizers,verbs=update
...
func (r *DhcpServerReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&routerosv1alpha1.DhcpServer{}).
		Complete(r)
}
