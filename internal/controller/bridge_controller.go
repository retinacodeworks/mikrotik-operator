...
//+kubebuilder:rbac:groups=routeros.mikrotik.com,resources=bridges,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=routeros.mikrotik.com,resources=bridges/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=routeros.mikrotik.com,resources=bridges/finalizers,verbs=update
