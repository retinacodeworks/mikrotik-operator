...
//+kubebuilder:rbac:groups=routeros.mikrotik.com,resources=addresses,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=routeros.mikrotik.com,resources=addresses/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=routeros.mikrotik.com,resources=addresses/finalizers,verbs=update
